...
const fill_color = "#00FFFF"
function drawBackground() {
    

    ctx.strokeStyle = "rgb(26, 0, 221)";
    ctx.lineWidth = 1;
...
class Write_A {
  constructor() {
    ...
    this.ball_three = { x: 0.05 * canvas.width+15, y: canvas.height / 1.8 };
  ...
  Ball_Three_Move() {
    if (this.vertical_distance < 260 && this.vertical_distance > 178) {
...
function restore(){
  ...
  A.ball_three = { x: 0.05 * canvas.width+15, y: canvas.height / 1.8 };
